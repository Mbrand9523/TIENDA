...
import perfectshoes.accesoadatos.CategoriasDAL;
import perfectshoes.entidadesdenegocio.Categorias;
   ...
   private Categorias obtenerCategorias(HttpServletRequest request)
    {
        ...
        categorias.setNombrescategorias(Utilidad.getParameter(request, "nombre", 
                ""));
        categorias.setIdProductos(Integer.parseInt(Utilidad.getParameter(request,
                "idProductos",
                "0")));
